...
intercepts_overrun_t intercepts_overrun[] =
{
  ...
  {4,   NULL, /* &swingy, */           NULL},
  {4,   NULL,                          NULL},
  {4, 1+(short*)&playerstarts[0][0].x,       1+(short*)&playerstarts[0][0].y},
  {4,           &playerstarts[0][0].angle,             &playerstarts[0][0].type},
  {4,           &playerstarts[0][0].options, 1+(short*)&playerstarts[0][1].x},
  {4, 1+(short*)&playerstarts[0][1].y,                 &playerstarts[0][1].angle},
  {4,           &playerstarts[0][1].type,              &playerstarts[0][1].options},
  {4, 1+(short*)&playerstarts[0][2].x,       1+(short*)&playerstarts[0][2].y},
  {4,           &playerstarts[0][2].angle,             &playerstarts[0][2].type},
  {4,           &playerstarts[0][2].options, 1+(short*)&playerstarts[0][3].x},
  {4, 1+(short*)&playerstarts[0][3].y,                 &playerstarts[0][3].angle},
